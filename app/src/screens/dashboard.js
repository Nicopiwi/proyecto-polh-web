...
function DashboardScreen(props) {
  ...
  const userName = useSelector((state) =>
    state.user.userType === "medico"
      ? `${state.user.userName} ${state.user.userSurname}`
      : state.user.userNombreEstablecimiento
  );
    ...
    <div>
      ...
      <List>
        <ListItem
          button
          onClick={() => {
            props.history.push("/dashboard/misrecetas");
          }}
        >
          <ListItemIcon>
            <RecetaIcon />
        ...
        {userType === "medico" && (
          <ListItem
            button
            onClick={() => {
              props.history.push("/dashboard/crearrecetas");
            }}
          >
            <ListItemIcon>
              <CrearIcon />
        ...
        <ListItem
          button
          onClick={() => {
            props.history.push("/dashboard/cuenta");
          }}
        >
          <ListItemIcon>
            <AccountCircleIcon />
